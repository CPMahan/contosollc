...
bastion_subnet_address_prefixes = ["172.18.0.32/27"]
app_gateway_subnet_name = "hub-eus-agw-sn"
app_gateway_subnet_address_prefixes = ["172.18.0.64/26"]
management_tools_subnet_name = "hub-eus-mgt-sn"
management_tools_subnet_address_prefixes = ["172.18.0.128/26"]
hub_endpoint_subnet_name = "hub-eus-pe-sn"
hub_endpoint_subnet_address_prefixes = ["172.18.1.0/25"]
dev_kv_subnet_name = "dev-eus-kv-sn"
dev_kv_subnet_address_prefixes = ["172.18.96.0/25"]
dev_data_subnet_name = "dev-eus-data-pe-sn"
dev_data_subnet_address_prefixes = ["172.18.97.0/24"]
dev_asp_subnet_name = "dev-eus-asp-sn"
dev_asp_subnet_address_prefixes = ["172.18.98.0/24"]
dev_asp_endpoint_subnet_name = "dev-eus-asp-pe-sn"
dev_asp_endpoint_subnet_address_prefixes = ["172.18.99.0/24"]
